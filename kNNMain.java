...
public class kNNMain{
...

  {
    ...
    String predict = determinenearest.predict(trainingSet, testSet.get(32));
    ...
    {
      String predictedlabel = determinenearest.predict(trainingSet,testSet.get(32));
      if(predictedlabel.equals(testSet.get(i).getLabel()))
      {
        c++;
      }
